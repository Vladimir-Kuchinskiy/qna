...
ActiveRecord::Schema.define(version: 20_180_911_083_018) do
  ...
  create_table 'answers', force: :cascade do |t|
    ...
    t.index %w[the_best question_id], name: 'index_answers_on_the_best_and_question_id', unique: true
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[question_id user_id], name: 'index_subscriptions_on_question_id_and_user_id', unique: true
